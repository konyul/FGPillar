...
class HCBAM(nn.Module):
    def __init__(self):
        ...
        self.bin_shuffle = bin_shuffle((32)*32, 32, True)
        self.up_dimension = conv1d(input_dim = 11, hidden_dim = 16, output_dim = 32, num_layers = 2)
        self.bin_shuffle_t = bin_shuffle((11)*10, 32, True)
