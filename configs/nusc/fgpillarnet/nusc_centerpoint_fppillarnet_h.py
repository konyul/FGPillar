...
tasks = [
    ...
    dict(stride=8, class_names=["motorcycle"]),
    dict(stride=8, class_names=["bicycle"]),
...
model = dict(
    ...
    pretrained=None,
    reader=dict(
        type="DynamicFGPillarFeatureNet",
        pillar_size=pillar_size,
        num_filters=(32, ),
        pc_range=pc_range,
        num_input_features=5,
        dsp_cfg=dict(model_name='DSP',
            use_downsample=True,
...
load_from = None
resume_from = 'work_dirs/nusc_centerpoint_fppillarnet_h/epoch_18.pth' 
workflow = [('train', 1)]
